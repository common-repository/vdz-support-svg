...
Donate link:  http://online-services.org.ua#Donate-vdz-support-svg
Tags: SVG, VDZ, Support SVG, Allow SVG
...
Simple add any svg for your site

== Description ==
VDZ Support SVG - Simple add any svg for your site, visible in post thumbnail, admin, editors and any page
...
* **[VDZ Contact Us](https://wordpress.org/plugins/vdz-support-svg/)**
